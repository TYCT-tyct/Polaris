...
EXPORTABLE_TABLES: tuple[str, ...] = (
    ...
    "arb_replay_metric",
    "view_arb_pnl_daily",
    "view_arb_by_strategy_mode_source",
    "view_arb_turnover",
    "view_arb_hit_ratio",
)
...
TIME_FILTER_COLUMNS: dict[str, str] = {
    ...
    "arb_signal": "created_at",
    "arb_order_intent": "created_at",
    "arb_order_event": "created_at",
    "arb_fill": "created_at",
    "arb_position_lot": "opened_at",
    "arb_cash_ledger": "created_at",
    "arb_trade_result": "created_at",
    "arb_risk_event": "created_at",
    "arb_param_snapshot": "created_at",
    "arb_replay_run": "started_at",
    "arb_replay_metric": "created_at",
    "view_arb_pnl_daily": "day_bucket",
    "view_arb_turnover": "hour_bucket",
}
